...
<div class="stat-block">
  ...
  <p>Expend one of your versatile vials to create a single alchemical consumable item of your level or lower that's in your formula book. Skip the normal monetary cost in alchemical raw materials and the Crafting check. This item has the infused trait. It must be activated before the start of your next turn or else it becomes inert.</p>
